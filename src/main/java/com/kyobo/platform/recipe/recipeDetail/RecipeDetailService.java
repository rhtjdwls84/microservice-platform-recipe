...
//	private final RecipeListRepository recipeListRepository;
	...
	private final RecipeDetailMapper recipeListMapper;
	
	@Cacheable(value = "RecipeList", key = "#recipe_user_id", cacheManager = "cacheManager")
	public List<RecipeDetail> getRecipeList(String recipe_user_id) {
		logger.info("====================== getRecipeList start ======================");
//		Optional<RecipeList> recipeList = recipeListRepository.findById(user_id);
		List<RecipeDetail> recipeList = recipeListMapper.getRecipeList(recipe_user_id);
		if(recipeList != null) {
