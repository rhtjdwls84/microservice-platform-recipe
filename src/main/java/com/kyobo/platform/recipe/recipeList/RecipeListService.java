...
public class RecipeListService {
	private static final Logger logger = (Logger) LoggerFactory.getLogger(RecipeListService.class);
...
//	private final RecipeListRepository recipeListRepository;
	...
	public List<RecipeList> getRecipeList(String recipe_user_id) {
		logger.info("====================== getRecipeList start ======================");
//		Optional<RecipeList> recipeList = recipeListRepository.findById(user_id);
		List<RecipeList> recipeList = recipeListMapper.getRecipeList(recipe_user_id);
		if(recipeList != null) {
